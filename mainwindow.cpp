...
void AddImageWindow::validateAdd() {
    ...
    // 3. Copier via OpenCV (assure la conversion au bon format)
      ...
      pipelineReady_(false)
{
    ...
    // ── Zone centrale : image test + photo de référence ───────────
    mainLayout->addSpacing(10);

    QHBoxLayout *imagesLayout = new QHBoxLayout();
    imagesLayout->setSpacing(20);

    // Colonne gauche : image à analyser
    ...
    // Colonne droite : photo de référence
